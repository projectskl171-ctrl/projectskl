            ...
            <div v-for="p in filtered" :key="p.id_pelanggan" class="rounded-xl border border-slate-200 dark:border-white/[0.06] bg-white dark:bg-white/[0.02] p-4">
                <div class="flex items-start justify-between gap-2">
                    ...
                    <div class="flex gap-1">
                        <button @click="edit(p)" class="rounded-md bg-slate-900/[0.04] dark:bg-white/5 px-2 py-1 text-[11px] font-bold hover:bg-slate-900/5 dark:hover:bg-white/10">Edit</button>
                        <button @click="store.deletePelanggan(p.id_pelanggan)" class="rounded-md bg-slate-900/[0.04] dark:bg-white/5 px-2 py-1 text-[11px] font-bold text-rose-700 dark:text-rose-300 hover:bg-rose-500/20">✕</button>
                    </div>
                </div>
